...
export async function up({ payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await payload.db.drizzle
    .run(sql`CREATE TABLE \`pages_blocks_content_columns\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  await payload.db.drizzle.run(sql`CREATE TABLE \`pages\` (
  	...
  	\`hero_link_appearance\` text DEFAULT 'default',
  ...
  await payload.db.drizzle
    .run(sql`CREATE TABLE \`_pages_v_blocks_content_columns\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`size\` text DEFAULT 'oneThird',
  ...
  await payload.db.drizzle
    .run(sql`CREATE TABLE \`_pages_v_blocks_media_block\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  await payload.db.drizzle.run(sql`CREATE TABLE \`_pages_v\` (
  	...
  	\`version_hero_link_appearance\` text DEFAULT 'default',
  ...
  await payload.db.drizzle.run(
    sql`CREATE INDEX \`posts_slug_idx\` ON \`posts\` (\`slug\`);`,
  );
  await payload.db.drizzle.run(
  ...
  await payload.db.drizzle
    .run(sql`CREATE TABLE \`_posts_v_version_populated_authors\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`_uuid\` text,
  ...
  `);
  await payload.db.drizzle.run(
    sql`CREATE INDEX \`categories_parent_idx\` ON \`categories\` (\`parent_id\`);`,
  );
  await payload.db.drizzle.run(
  ...
  await payload.db.drizzle
    .run(sql`CREATE TABLE \`forms_blocks_select_options\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`label\` text NOT NULL,
  ...
  await payload.db.drizzle
    .run(sql`CREATE TABLE \`form_submissions_submission_data\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`field\` text NOT NULL,
  ...
  `);
  await payload.db.drizzle.run(
    sql`CREATE INDEX \`search_slug_idx\` ON \`search\` (\`slug\`);`,
  );
  await payload.db.drizzle.run(
    sql`CREATE INDEX \`search_meta_meta_image_idx\` ON \`search\` (\`meta_image_id\`);`,
  );
  await payload.db.drizzle.run(
  ...
  await payload.db.drizzle.run(
    sql`CREATE INDEX \`search_rels_posts_id_idx\` ON \`search_rels\` (\`posts_id\`);`,
  );
...
export async function down({ payload, req }: MigrateDownArgs): Promise<void> {
  ...
  await payload.db.drizzle.run(
    sql`DROP TABLE \`pages_blocks_content_columns\`;`,
  );
  ...
  await payload.db.drizzle.run(
    sql`DROP TABLE \`_pages_v_blocks_content_columns\`;`,
  );
  await payload.db.drizzle.run(sql`DROP TABLE \`_pages_v_blocks_content\`;`);
  await payload.db.drizzle.run(
    sql`DROP TABLE \`_pages_v_blocks_media_block\`;`,
  );
  ...
  await payload.db.drizzle.run(
    sql`DROP TABLE \`_posts_v_version_populated_authors\`;`,
  );
  ...
  await payload.db.drizzle.run(
    sql`DROP TABLE \`forms_blocks_select_options\`;`,
  );
  ...
  await payload.db.drizzle.run(
    sql`DROP TABLE \`form_submissions_submission_data\`;`,
  );
